...
func TestMapReduce_inMemoryLarge(t *testing.T) {
	// Create a bunch of documents, filled with numeric strings (words are all
	...
	check := func(numMappers, numReducers int) bool {
		ctx := context.Background()
