...
// UUIDGenerator is a default ID generator that produces UUIDs as strings. If
// nothing is specified using WithIDGenerator, this function will be used to
// generate new IDs.
...
// claimant IDs when autogenerated. By default, this will be UUIDGenerator.
